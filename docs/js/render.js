// render.js
import { db, state, saveDbToStorage, generateNextSongId } from './db.js';
import { $, pruneUnusedTags, countTagUsed, getTagName, splitNameTokens, addTag, refreshTagsViewIfActive } from './utils.js';
  ...
  container.innerHTML = `
    <div class="detail-grid">
      <div>
        ...
        <div class="detail-field">
          <span class="detail-label">歌唱者: </span>${artistNames || "-"}
        </div>
        <div class="detail-field">
